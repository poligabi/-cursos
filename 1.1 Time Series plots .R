...
*Ljung-Box test = considers the first h autocorrelation values together. A significant test (small p value) indicates the 
data are probably not white noise.
...
interest rates and transaction costs). The consequence for forecasters is that the best forecast of the future price is the current 
price.
